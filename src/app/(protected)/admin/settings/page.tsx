      ...
      <div className="space-y-4">
        ...
        <div className="rounded-2xl border border-slate-200/80 bg-white/80 p-6 shadow-sm">
          ...
          <div className="space-y-3">
            {[
              ...
              <label key={item.label} className="flex items-center justify-between rounded-xl px-4 py-3 bg-slate-50/60 border border-slate-100 cursor-pointer hover:bg-slate-50">
        ...
        <div className="flex justify-end pt-2">
          <button onClick={handleSave}
            className={`flex items-center gap-2 rounded-xl px-6 py-3 text-sm font-semibold text-white shadow-lg transition-all active:scale-95
